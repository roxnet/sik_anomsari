			...
			<div class="tab-content">
				<!--<div class="row">
					<div class="col-xs-6">
						...
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_fcategory"><i class="fa fa-fw fa-plus"></i></button>
				...
				<div class="row" >
					<!--<div class="col-md-2 " style="">
						<div class="table-responsive " id="list_forum" style=""><!-- ......................................memulai tabel responsive 1-->
						<!--	 <table class="table  " style="border:solid #3BD23B 1px;background-color:white"> 
					...
					<div class="col-md-12">
					<?php 	$sql0 = mysqli_query($koneksi, "SELECT * FROM fcategory "); 
					if(mysqli_num_rows($sql0) == 0){ 
							echo '<tr><td colspan="4"><center>Data Tidak Ada.</center></td></tr>'; // jika tidak ada entri di database maka tampilkan 'Data Tidak Ada.'
							 ...
							 // mewakili data dari nomor 1
							while($row0 = mysqli_fetch_assoc($sql0)){ // fetch query yang sesuai ke dalam array
							
								echo' <div class="" >
										 <div class="table-responsive " id="list_forum" ><!-- ......................................memulai tabel responsive 1-->
										  <table class="table  " style="border:solid #2eb82e 1px;background-color:#FFFFFF"> 
											<tr style="background-color:#2eb82e;color:#FFFFFF">
												<td width="6%"></td>
												<td width="30%" >Forum '.$row0['category'].'</td>
												<td width="20%" align="center">Topik bahasan</td>
												<td width="30%" align="center">Created at</td>
											</tr>';

											$sql = mysqli_query($koneksi, "SELECT * FROM forum ORDER BY id_forum DESC"); // jika tidak ada filter maka tampilkan semua entri

												if(mysqli_num_rows($sql) == 0){ 
													echo '<tr><td colspan="4" style="opacity:0.4"><center>Tidak Ada Forum Untuk Kategori Ini.</center></td></tr>'; // jika tidak ada entri di database maka tampilkan 'Data Tidak Ada.'
												}
												else{ // jika terdapat entri maka tampilkan datanya
													 // mewakili data dari nomor 1
													while($row = mysqli_fetch_assoc($sql)){ // fetch query yang sesuai ke dalam array
														...
														if($row['status']=="online"){
															if($row['id_fkategory']==$row0['id_category']){
																echo '
																<tr class="" >
																	<td></td>
																	<td width="35%" ><a href="layout_user.php?Threads=yes&id='.$row['id_forum'].'">'.$row['judul_forum'].'</a></td>
																	<td align="center"><h4><span class="label label-success" style="border-radius:90px">';
																	$banyaknya_bahasan = mysqli_query($koneksi,"SELECT id_bahasan FROM bahasan_forum WHERE id_forum = '".$row['id_forum']."'");
																	$jumlh= mysqli_num_rows($banyaknya_bahasan);
																	echo $jumlh;
																	
																echo'				<i class="glyphicon glyphicon-menu-hamburger"></i></span></h4>
																	</td>
																	<td align="center"><h5><i class="glyphicon glyphicon-time" ></i> '.date("d F Y", strtotime($row['created_at'])).'<h5></td>
																</tr>
