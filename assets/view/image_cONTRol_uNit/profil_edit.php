  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content" style="border-radius:0px">
      ...
      <div class="modal-footer">
        <a href="../admin_layout.php?edit_anggota=yes&id=<?php echo $id ;?>" id="batalsimpanImage" type="button" class="btn btn-default" data-dismiss="modal">Batal</a>
	...
	function simpan(){
		...
		$.ajax({
			...
			data  :"do=edit&user="+user+"&profil="+profil,
