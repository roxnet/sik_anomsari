                            ...
                            <div class="panel-body">
                                ...
                                <?php
                                    ...
                                    $person_chat=mysqli_query($koneksi,"
                                        ...
                                        ");
                                    $person_data=mysqli_fetch_array($person_chat);
                                	if(mysqli_num_rows($chat1)!=0){
                                		...
                                		while($chat_data1=mysqli_fetch_array($chat1)){
                                			...
                                			echo "<div style='background-color:gray;text-align:center;padding:5px'><a href='#' onclick='pesan(".$chat_data1['id_anggota'].")'><span class='glyphicon glyphicon-user' aria-hidden='true'> ".$chat_data1['name']."</span></a></div>";
                                            }
                                            else {
