  ...
  <div class="modal-dialog" role="document" >
    <div class="modal-content" style="border-radius:0px">
      ...
      <div class="modal-footer">
        <button onclick="lewat_aja()" id="batalsimpanImage" type="button" class="btn btn-success" data-dismiss="modal" onclick="simpan()">Lewati>></button>
	...
	function simpan(){
		...
		$.ajax({
			type	:"POST",
			url		:"../../kontrol/image_control_unit/link_profil_to_db.php",
			data  :"do=lewat_ja&id="+id+"&user="+user,
			success	: function(data){
