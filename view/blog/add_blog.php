				...
				<div class="form-group">
					...
					<div class="form-inline">
						<div class="form-group">
							...
							<?php
								$query=mysqli_query($koneksi,"SELECT id_category,category 
									FROM bcategory");
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form>
			  ...
			  <hr/>
			  <?php
				$sql=mysqli_query($koneksi,"SELECT id_category,category 
					FROM bcategory");
...
$(document).ready(function(){
	...
	$("#submit_content").click(function(){
		...
		console.log(id_anggota,judul,category,filter);
		$.ajax({
			type	:"POST",
